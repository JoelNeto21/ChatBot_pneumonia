...
3. [Stack e Arquitetura](#️-stack-tecnológica)
4. [Como Executar Localmente](#-como-executar-localmente)
5. [Estrutura do Repositório](#-estrutura-do-repositório)
6. [Roadmap](#-roadmap-de-desenvolvimento)

---

## 📖 Sobre o Projeto

Em ambientes hospitalares e de pronto-atendimento, o tempo é um recurso vital. O **PneumoAssist** foi idealizado para mitigar gargalos na triagem de pacientes com queixas respiratórias. 

Através da integração com a API da **Groq**, a plataforma alcança tempos de resposta quase instantâneos na análise de dados complexos, permitindo que a IA correlacione sintomas relatados e forneça insights baseados em diretrizes médicas atualizadas, garantindo que o médico tenha um panorama claro antes mesmo do contato direto com o paciente.
...
| **💬 Chatbot Clínico Contextual** | Sistema de triagem interativo que avalia sintomas (tosse, dispneia, dor torácica) utilizando raciocínio clínico simulado e linguagem acessível. |
...
* **Estilização e UI:** `Tailwind CSS` - Para construção rápida de interfaces consistentes e responsivas.
...
| [<img loading="lazy" src="https://images.unsplash.com/photo-1602992708529-c9fdb12905c9?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" width=100 style="border-radius: 50%"><br><sub><b>MIGUEL MASSANE</b></sub>](https://github.com/) | [<img loading="lazy" src="https://images.unsplash.com/photo-1629904853893-c2c8981a1dc5?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" width=100 style="border-radius: 50%"><br><sub><b>MURILO ALMEIDA DE OLIVEIRA</b></sub>](https://github.com/) | [<img loading="lazy" src="https://images.unsplash.com/photo-1629904853716-f0bc54eea481?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" width=100 style="border-radius: 50%"><br><sub><b>JOEL JOÃO DE ARAUJO NETO</b></sub>](https://github.com/) | [<img loading="lazy" src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" width=100 style="border-radius: 50%"><br><sub><b>JULIO SENA</b></sub>](https://github.com/) |
| :---: | :---: | :---: | :---: |
